...
class TikTok():
    ...
    def next_data(self, max_cursor):
        ...
        api_naxt_post_url = f'https://www.iesdouyin.com/web/api/v2/aweme/post/?sec_uid={key}&count=100&max_cursor={max_cursor}&aid=1128&_signature=PDHVOQAAXMfFyj02QEpGaDwx1S&dytk='
